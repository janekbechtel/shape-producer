...
class QCDEstimation_ABCD_TT_ISO2(ABCDEstimationMethod):
    def __init__(self, era, directory, channel, bg_processes, data_process, friend_directory=None, folder="nominal", extra_chain=None):
...
class VVEstimation(EstimationMethod):
    def __init__(self, era, directory, channel, friend_directory=None, folder="nominal", extra_chain=None):
...
class VHEstimation(HTTEstimation):
    def __init__(self, era, directory, channel, friend_directory=None):
        super(HTTEstimation, self).__init__(
            name="VH",
            folder="nominal",extra_chain=None,
            era=era,
            directory=directory,
            friend_directory=friend_directory,
            channel=channel,
...
class SUSYggHEstimation(EstimationMethod):
    def __init__(self, era, directory, channel, mass, friend_directory=None, folder="nominal", extra_chain=None):
